...
onBeforeMount(() => {
  ...
  email.value = queryString.email;
  token = queryString.token;
  if (!queryString.email || !queryString.token) router.push({name: 'invalid-access'});
});
  ...
  <div class="h-screen flex justify-content-center align-items-center">
    <div class="surface-card p-4 shadow-2 border-round w-3">
      ...
      <div>
        ...
        <InputText :modelValue="email" id="email" type="text" class="w-full mb-3" disabled/>
