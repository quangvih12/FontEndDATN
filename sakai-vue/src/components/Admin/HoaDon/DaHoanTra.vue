...
const searchDate = async () => {
    if (startDate.value == null || endDate.value == null) {
        ...
        const respone = await useHD.searchDateByTrangThai(startDate.value, endDate.value, 'ngayTao', 10);
        data.value = respone;
    } else {
        const respone = await useHD.searchDateByTrangThai(startDate.value, endDate.value, typeSearchDate.value.value, 10);
        data.value = respone;
    }
};
