...
<template>
    <div class="p-fluid formgrid grid">
                ...
                <Panel header="Tìm kiếm" style="width: 100%; height: 40px;">
                    <div class="flex flex-wrap gap-3" style="display: flex;">
                        ...
                        <Button type="button" label="khác" @click="toggle1"
                            ...
                            <Button type="button" label=" file báo cáo" 
                            style="width: 120px; height: 40px;background: none;   color: black;" />
        ...
        <div class="Field col-12 md:col-12"
            style="background: rgb(255, 255, 255);display: flex; margin-left: 3px; margin-top: 10px; width: 100%;height: 130px;">


            <div class="flex Field col-12 md:col-6" style=" margin-right: 10px;height: 30px; margin-left: -15px; height: 100%;
             border-radius: 20px;background-color: #f4f4f4;
    box-shadow: 5px 5px 5px grey; ">
                <div class="Field col-12 md:col-4"
                    style=" margin-top: 10px;margin-left: -12px; height: 80%; border-right: 1px solid; ">
                    <div style="font-weight: 700;">
                        Doanh thu:
                    </div>
                    <div style="margin-right: 20px; margin-top: 20px; text-align: center;">
                            <p class="m-0" style="text-align: center; font-weight: 700; font-size: 1.2rem;">{{
                                formatCurrency(doanhThu) }}</p>
                        </div>
                </div>
                <div class="Field col-12 md:col-4"
                    style="margin-top: 10px; margin-left: 12px; height: 80%;border-right: 1px solid; ">
                    ...
                    <div style="margin-right: 20px; margin-top: 20px; text-align: center;">
                            <p class="m-0" style="text-align: center; font-weight: 700; font-size: 1.2rem;">{{
                                formatCurrency(doanhThuTaiQuay) }}</p>
                        </div>
                </div>
                <div class="Field col-12 md:col-4" style="margin-top: 10px; margin-left: 12px;height: 80%; ">
                    ...
                    <div style="margin-right: 20px; margin-top: 20px; text-align: center;">
                            <p class="m-0" style="text-align: center; font-weight: 700; font-size: 1.2rem;">{{
                                formatCurrency(doanhThuOnline) }}</p>
                        </div>
                </div>

            </div>
            <div class="flex Field col-12 md:col-6" style="margin-right: 10px;height: 30px;  height: 100%;
             border-radius: 20px;background-color: #f4f4f4;
    box-shadow: 5px 5px 5px grey; ">
                <div class="Field col-12 md:col-4"
                    style=" margin-top: 10px;margin-left: -12px; height: 80%; border-right: 1px solid; ">
        ...
        <div class="Field col-12 md:col-12"
            style="background: rgb(255, 255, 255);display: flex; margin-left: 0px; margin-top: 20px;">
            ...
            <div class="" style="margin-bottom: 10px; background: rgb(255, 255, 255); width: 1110px; margin-left: 10px;">
                ...
                <div class="Field col-12 md:col-9"
                    ...
                    <div class="Field col-12 md:col-6"
                        style=" margin-left: -10px;margin-bottom: 10px; background: rgb(255, 255, 255); height: 260px;border-radius: 20px; margin-right: 20px;order-radius: 20px; border: 1px solid black">
