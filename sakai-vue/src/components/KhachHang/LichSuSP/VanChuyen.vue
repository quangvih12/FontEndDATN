...
<template>
    ...
    <div v-for="(items, index) in listSP" :key="index">
        ...
        <div class="san-pham">
            <p>
                <span class="hoan-thanh">{{ items.trangThai == 3 ? 'Đang chuẩn bị hàng' : 'Giao thất bại' }} <i class="pi pi-check" style="font-size: 1rem"></i></span> <span class="gach"> | </span>
                <span class="giao-thanh-cong"> {{ items.trangThai == 3 ? 'Đơn hàng đang được chuẩn bị' : 'Đơn hàng đã được giao thất bại' }} <i class="pi pi-truck" style="font-size: 1.5rem"></i></span>
            </p>
        </div>
        <div class="thong-tin-sp">
            ...
            <div style="text-align: right">
                ...
                <Button class="my-button" label="Xem" severity="danger" />
            </div>
        </div>
        <!-- <div class="rong"></div> -->
    </div>
